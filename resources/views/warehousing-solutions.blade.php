            ...
            <div class="col-md-6 text-md-start text-center animate__animated animate__fadeInLeft">
                ...
                <h1 class="hero-title mb-4">
                    {!! data_get(
                        $heroContent,
                        'content.title',
                        'Store. Manage. Fulfil—Smarter <span class="moving-gradient-text">from The USA</span>',
                    ) !!}
                </h1>
                ...
                <div class="hero-badges">
                    <!-- @foreach (data_get($heroContent, 'content.list_items', ['Inventory Management', 'Fast Fulfillment', '220+ Countries']) as $badge)
...
@endforeach -->
            ...
            <div class="col-md-6 text-center">
                <div class="hero-graphic">
                    <div style="width: 400px; height: 400px;" class="plane-circle">
                        <img src="{{ asset('assets/images/warehousing.webp') }}" class="img-fluid"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-content">
                    <h2 class="about-title">{!! data_get(
                        $overviewContent,
                        'content.title',
                        'Store. Manage. Fulfil—Smarter <span class="moving-gradient-text">from The USA</span>',
                    ) !!}</h2>
                    <p class="lead">
                        {{ data_get($overviewContent, 'content.paragraphs', 'United Worldwide Couriers offers an exceptional Express Air Freight service built for B2B enterprises, e-commerce businesses, and time-critical international shipments. We operate an end-to-end ecosystem from collection to customs clearance to last-mile delivery all under one roof. Our services span air freight to over 220 countries, including door-to-door personal import pickups and full freight-forwarding with seamless documentation. Each shipment is handled by a dedicated logistics specialist and backed by real-time tracking.') }}
                    </p>

                    <ul class="check-list lead">
                        @foreach (data_get($overviewContent, 'content.list_items', ['Priority loading on partner airline networks across 6 continents', 'Full customs brokerage with pre-clearance documentation support', 'Dedicated account manager and 24/7 live shipment support', 'Door-to-door delivery with real-time GPS tracking portal', 'Fulfilment services, returns management, and COD options']) as $bullet)
        ...
        <div class="row justify-content-center mb-3">
            <div class="col-lg-10 text-center">
                <h2 class="about-title">
                    {{ data_get($featuresHeaderContent, 'content.title', 'What Makes Our E-commerce Logistics Stand Out') }}
                </h2>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="feature-card">
                        ...
                        <p>Monitor your shipment at every checkpoint — from pickup to customs to final-mile — through
                            our live dashboard and SMS alerts.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="feature-card">
...
@if ($ctaContent)
    <section class="cta-section py-5 bg-primary text-white" style="display:none">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h2 class="about-title text-white">
                        {{ data_get($ctaContent, 'content.title', 'Ready to simplify your warehousing and fulfillment?') }}
                    </h2>
                    <p class="about-desc text-white">
                        {{ data_get($ctaContent, 'content.subtitle', 'Let our warehousing solutions take the complexity out of your supply chain, so you can focus on growth and customer satisfaction.') }}
                    </p>
                </div>
                <div class="col-lg-4 text-lg-end text-center mt-4 mt-lg-0">
                    <a href="{{ data_get($ctaContent, 'content.button_url', '#') }}"
                        class="btn btn-light btn-lg">{{ data_get($ctaContent, 'content.button_text', 'Get Started Today') }}</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mb-3">
            <div class="col-lg-8 text-center">
                ...
                <p class="about-desc text-center">
                    Join our growing network of satisfied clients who depend on us for easy, secure, fast, and efficient
                    logistics solutions. More than three decades (30+ years) of our positive track record speaks for
                    itself. From on-time delivery and zero-compromise on quality to customer satisfaction, United
                    Worldwide Couriers is completely reliable and trustworthy.
                </p>
            </div>
        </div>
                ...
                @empty
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">"Very reliable logistics partner with consistent performance,
                            ensuring all my shipments arrive safely, securely, and always on time without any issues."
                        </p>
                        <div class="user-info"> <img src="{{ asset('public/website_images/review-1.png') }}"
                                class="img-fluid">
                            <h6>Shelly Kapoor</h6>
                        </div>
                    </div>
...
<section class="faq-section" style="display:none">
    <div class="container">
        <div class="faq-header">
            ...
            <h2 class="about-title">{{ data_get($faqHeaderContent, 'content.title', 'Frequently Asked Questions') }}
            </h2>
        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq1" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    ...
                                    your first pickup. Thereafter, the team will guide you through every step of the
                                    process.
                                </div>
                            </div>
                        </div>
