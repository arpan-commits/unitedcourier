...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-text">View and Edit all E-Commerce Logistics Solutions page content
                                    sections</p>
                            </div>
                            <div class="card-body">
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center py-4">
                                                        <p class="text-muted">No e-commerce logistics solutions content
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form id="editForm" method="POST"
                    action="{{ route('admin.store-e-commerce-logistics-solutions-content') }}"
                                ...
                                <div id="heroFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="heroBadgeText"
                                            name="content[badge_text]" placeholder="E-commerce Logistics Solutions">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="heroImage"
                                            name="content[image]"
                                            placeholder="Image path (e.g., images/ecomm-service.webp)">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div id="overviewFields" style="display:none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="overviewImage"
                                            name="content[image]"
                                            placeholder="Image path (e.g., images/map-pattern.png)">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div id="testimonialsHeaderFields" style="display:none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="testimonialsGoogleReview"
                                            ...
                                            placeholder="images/google-review.png">
                                    </div>
                                </div>
                                ...
                                <div id="faqHeaderFields" style="display:none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="faqHeaderSidebarImage"
                                            name="content[sidebar_image]" placeholder="Sidebar image URL">
                                    </div>
                                    <div class="mb-3">
    ...
    <script>
        ...
        function editContent(id) {
            ...
            fetch(`${BASE_URL}/admin/get-e-commerce-logistics-solutions-content/${id}`, {
                ...
                .then(data => {
                    ...
                    form.action =
                        '{{ route('admin.update-e-commerce-logistics-solutions-content', ['id' => '__ID__']) }}'
                        .replace('__ID__', id);
                    ...
                    switch (data.section) {
                        case 'hero':
                            ...
                            if (Array.isArray(content.badges)) {
                                document.getElementById('heroBadges').value = content.badges.map(b =>
                                    `${b.icon}|${b.text}`).join('\n');
                            } else {
                        ...
                        case 'faq_header':
                            ...
                            document.getElementById('faqHeaderSidebarDescription').value = content
                                .sidebar_description || '';
                            document.getElementById('faqHeaderContactBoxTitle').value = content.contact_box_title || '';
                            document.getElementById('faqHeaderContactBoxDescription').value = content
        ...
        document.getElementById('editForm').addEventListener('submit', function(e) {
            ...
            let url = id ? `${BASE_URL}/admin/update-e-commerce-logistics-solutions-content/${id}` :
                `${BASE_URL}/admin/store-e-commerce-logistics-solutions-content`;
        ...
        function getSectionFieldIds() {
            return ['heroFields', 'statsFields', 'featuresFields', 'featuresHeaderFields', 'overviewFields',
                'testimonialsFields', 'testimonialsHeaderFields', 'faqFields', 'faqHeaderFields'
            ];
        }
