...
<body>
                                                            ...
                                                            @if (is_array($contentData) && count($contentData) > 0)
                                                                <table class="table table-sm table-bordered mb-0"
                                                                    ...
                                                                    @foreach ($contentData as $key => $val)
                                                                        @if ($val !== null)
                                                                            <tr>
                                                                                <td class="fw-semibold text-nowrap p-1"
                                                                                    style="width: 30%;">
                                                                                    {{ $key }}</td>
                                                                                <td class="p-1"
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <button type="button"
                                                                ...
                                                                data-content='{!! json_encode($contentData, JSON_HEX_APOS) !!}'
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center py-4">
                                                        <p class="text-muted">No warehousing solutions content found.
                                                            The page is empty.</p>
                                                    </td>
                                                </tr>
                                            @endforelse
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form id="editForm" method="POST"
                    action="{{ route('admin.store-warehousing-solutions-content') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control font-monospace" id="extraContent" name="extra_content" rows="4"
                                        placeholder='{"custom_key": "custom_value", "another_key": "value"}'></textarea>
                                    <small class="text-muted">Optional: JSON key-value pairs that will be merged into
                                        the content array. These values override any other content fields with the same
                                        key.</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="heroFields" style="display:none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="heroImage"
                                            name="content[image]"
                                            placeholder="Image path (e.g., images/warehousing.webp)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="heroListItems" class="form-label">List Items
                                            (comma-separated)</label>
                                        <textarea class="form-control" id="heroListItems" name="content[list_items]" rows="2"
                                ...
                                <div id="statsFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="statNumber"
                                            name="content[stat_number]" placeholder="50000+">
                                    </div>
                                    <div class="mb-3">
                                        <label for="statLabel" class="form-label">Stat Label</label>
                                        <input type="text" class="form-control" id="statLabel"
                                            name="content[stat_label]" placeholder="Sq Ft Storage Space">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div id="featuresFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="featureSubtitle"
                                            name="content[subtitle]" placeholder="Feature subtitle">
                                    </div>
                                    <div class="mb-3">
                                        <label for="featureParagraphs" class="form-label">Paragraphs</label>
                                        <textarea class="form-control" id="featureParagraphs" name="content[paragraphs]" rows="3"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="featureIconClass"
                                            name="content[icon_class]" placeholder="fi-blue">
                                    </div>
                                </div>
                                ...
                                <div id="featuresHeaderFields" style="display:none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="featuresHeaderSubtitle"
                                            name="content[subtitle]" placeholder="Features header subtitle">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="featuresHeaderParagraph" name="content[paragraphs]" rows="3"
                                            placeholder="Section description"></textarea>
                                    </div>
                                </div>
                                ...
                                <div id="overviewFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="overviewTitle"
                                            name="content[title]" placeholder="Overview title">
                                    </div>
                                    <div class="mb-3">
                                        <label for="overviewParagraphs" class="form-label">Paragraphs</label>
                                        <textarea class="form-control" id="overviewParagraphs" name="content[paragraphs]" rows="3"
                                            placeholder="Overview content"></textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="overviewListItems" class="form-label">List Items
                                            (comma-separated)</label>
                                        <textarea class="form-control" id="overviewListItems" name="content[list_items]" rows="3"
                                            placeholder="Item 1, Item 2, Item 3"></textarea>
                                        <small class="text-muted">Enter list items separated by commas</small>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div id="ctaFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ctaTitle"
                                            name="content[title]" placeholder="CTA title">
                                    </div>
                                    <div class="mb-3">
                                        <label for="ctaSubtitle" class="form-label">Subtitle</label>
                                        <input type="text" class="form-control" id="ctaSubtitle"
                                            name="content[subtitle]" placeholder="CTA subtitle">
                                    </div>
                                    <div class="mb-3">
                                        <label for="ctaButtonText" class="form-label">Button Text</label>
                                        <input type="text" class="form-control" id="ctaButtonText"
                                            name="content[button_text]" placeholder="Button text">
                                    </div>
                                    <div class="mb-3">
                                        <label for="ctaButtonUrl" class="form-label">Button URL</label>
                                        <input type="text" class="form-control" id="ctaButtonUrl"
                                            name="content[button_url]" placeholder="# or URL">
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function editContent(button, id, section, itemKey, sortOrder, isActive) {
            ...
            form.action = '{{ route('admin.update-warehousing-solutions-content', ['id' => '__ID__']) }}'.replace('__ID__',
                id);
            ...
            switch (formSection) {
                case 'hero':
                    ...
                    document.getElementById('heroListItems').value = Array.isArray(content.list_items) ? content.list_items
                ...
                case 'overview':
                    ...
                    document.getElementById('overviewListItems').value = Array.isArray(content.list_items) ? content
                        .list_items.join(', ') : (content.list_items || '');
            ...
            const handledKeys = ['title', 'subtitle', 'paragraphs', 'badge_text', 'button_text', 'button_url', 'image',
                'list_items', 'stat_number', 'stat_label', 'suffix', 'icon_svg', 'icon_class', 'question', 'answer',
                'description'
            ];
            const filteredExtra = {};
            ...
            document.getElementById('extraContent').value = Object.keys(filteredExtra).length > 0 ? JSON.stringify(
                filteredExtra, null, 2) : '';
        }
        ...
        document.getElementById('editForm').addEventListener('submit', function(e) {
            ...
            let url = id ? `${BASE_URL}/admin/update-warehousing-solutions-content/${id}` :
                `${BASE_URL}/admin/store-warehousing-solutions-content`;
        ...
        function getSectionFieldIds() {
            return ['heroFields', 'statsFields', 'featuresFields', 'featuresHeaderFields', 'overviewFields', 'faqFields',
                'ctaFields'
            ];
        }
