...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-text">View and Edit all Express Air Freight Solutions page content
                                    sections</p>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover" id="expressAirContentTable">
                                        ...
                                        <tbody>
                                            @forelse($expressAirContent as $content)
                                                @php
                                                    $contentData = is_array($content->content)
                                                        ? $content->content
                                                    ...
                                                    <td>
                                                        <div class="content-preview">
                                                            ...
                                                            @elseif($content->section === 'stats')
                                                                <strong>{{ $contentData['value'] ?? '' }}</strong>
                                                                {{ $contentData['suffix'] ?? '' }}<br>
                                                            ...
                                                            @else
                                                                <small
                                                                    class="text-muted">{{ \Illuminate\Support\Str::limit(json_encode($contentData), 50) }}</small>
                                                            @endif
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <button type="button"
                                                                ...
                                                                data-content='@json($contentData)'
                                                                onclick="editContent(this, {{ $content->id }}, '{{ $content->section }}', '{{ $content->item_key }}', {{ $content->sort_order }}, {{ $content->is_active ? 1 : 0 }})">
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center py-4">
                                                        <p class="text-muted">No express air freight solutions content
                                                            found. The page is empty.</p>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form id="editForm" method="POST"
                    action="{{ route('admin.store-express-air-freight-solutions-content') }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="itemKey" name="item_key"
                                        placeholder="e.g., hero_main, stat_1" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="heroFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="heroBadgeText"
                                            name="content[badge_text]" placeholder="Express Air Freight Solutions">
                                    </div>
                                    <div class="mb-3">
                                        <label for="heroTitle" class="form-label">Title</label>
                                        <input type="text" class="form-control" id="heroTitle"
                                            name="content[title]" placeholder="Hero title (HTML allowed)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="heroDescription" class="form-label">Description</label>
                                        <textarea class="form-control" id="heroDescription" name="content[description]" rows="2"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="heroImage"
                                            name="content[image]"
                                            placeholder="Image path (e.g., public/website_images/air-freight-service.webp)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="heroBadges" class="form-label">Badges (one per line:
                                            icon|text)</label>
                                        <textarea class="form-control" id="heroBadges" name="content[badges]" rows="3"
                                            placeholder="fa-clock|24–72 Hr Delivery&#10;fa-shield-alt|Fully Insured"></textarea>
                                        <small class="text-muted">Format: icon|text (one per line)</small>
                                    </div>
                                    <div class="mb-3">
                                        <label for="heroStatPills" class="form-label">Stat Pills (one per line:
                                            icon|value|label|color|text_color)</label>
                                        <textarea class="form-control" id="heroStatPills" name="content[stat_pills]" rows="3"
                                            placeholder="fa-box|50K+|Shipments/Month|rgba(...)|var(--primary)"></textarea>
                                        <small class="text-muted">Format: icon|value|label|bg_color|text_color (one per
                                            line)</small>
                                    </div>
                                </div>
                                ...
                                <div id="statsFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="statsTitle"
                                            name="content[title]" placeholder="Section title (HTML allowed)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="statValue" class="form-label">Value</label>
                                        <input type="text" class="form-control" id="statValue"
                                            name="content[value]" placeholder="150">
                                    </div>
                                    <div class="mb-3">
                                        <label for="statSuffix" class="form-label">Suffix</label>
                                        <input type="text" class="form-control" id="statSuffix"
                                            name="content[suffix]" placeholder="+">
                                    </div>
                                    <div class="mb-3">
                                        <label for="statLabel" class="form-label">Label</label>
                                        <input type="text" class="form-control" id="statLabel"
                                            name="content[label]" placeholder="Cities Covered">
                                    </div>
                                </div>
                                ...
                                <div id="overviewFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="overviewTitle"
                                            name="content[title]" placeholder="Overview title (HTML allowed)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="overviewDescription" class="form-label">Description</label>
                                        <textarea class="form-control" id="overviewDescription" name="content[description]" rows="3"
                                            placeholder="Overview description"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="overviewImage" class="form-label">Image</label>
                                        <input type="text" class="form-control" id="overviewImage"
                                            name="content[image]"
                                            placeholder="Image path (e.g., public/website_images/map-pattern.png)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="overviewButtonText" class="form-label">Button Text</label>
                                        <input type="text" class="form-control" id="overviewButtonText"
                                            name="content[button_text]" placeholder="Book Shipments">
                                    </div>
                                    <div class="mb-3">
                                        <label for="overviewButtonUrl" class="form-label">Button URL</label>
                                        <input type="text" class="form-control" id="overviewButtonUrl"
                                            name="content[button_url]" placeholder="# or URL">
                                    </div>
                                    <div class="mb-3">
                                        <label for="overviewCheckList" class="form-label">Check List Items (one per
                                            line)</label>
                                        <textarea class="form-control" id="overviewCheckList" name="content[check_list]" rows="4"
                                            placeholder="Priority loading on partner airline...&#10;Full customs brokerage with..."></textarea>
                                ...
                                <div id="featuresHeaderFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="featuresHeaderTitle"
                                            name="content[title]" placeholder="Features header title">
                                    </div>
                                    <div class="mb-3">
                                        <label for="featuresHeaderDescription" class="form-label">Description</label>
                                        <textarea class="form-control" id="featuresHeaderDescription" name="content[description]" rows="3"
                                ...
                                <div id="featuresFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="featureIcon"
                                            name="content[icon]" placeholder="fa-satellite">
                                    </div>
                                    <div class="mb-3">
                                        <label for="featureColorClass" class="form-label">Color Class</label>
                                        <input type="text" class="form-control" id="featureColorClass"
                                            name="content[color_class]" placeholder="fi-blue">
                                    </div>
                                    <div class="mb-3">
                                        <label for="featureTitle" class="form-label">Title</label>
                                        <input type="text" class="form-control" id="featureTitle"
                                            name="content[title]" placeholder="Real-Time Tracking">
                                    </div>
                                    <div class="mb-3">
                                        <label for="featureDescription" class="form-label">Description</label>
                                        <textarea class="form-control" id="featureDescription" name="content[description]" rows="3"
                                ...
                                <div id="testimonialsHeaderFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="testimonialsHeaderTitle"
                                            name="content[title]" placeholder="Testimonials header title">
                                    </div>
                                    <div class="mb-3">
                                        <label for="testimonialsHeaderDescription"
                                            class="form-label">Description</label>
                                        <textarea class="form-control" id="testimonialsHeaderDescription" name="content[description]" rows="3"
                                            placeholder="Section description"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="testimonialsGoogleReview" class="form-label">Google Review
                                            Image</label>
                                        <input type="text" class="form-control" id="testimonialsGoogleReview"
                                            name="content[google_review_image]"
                                            placeholder="public/website_images/google-review.png">
                                    </div>
                                </div>
                                ...
                                <div id="testimonialsFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="testimonialName"
                                            name="content[name]" placeholder="John Doe">
                                    </div>
                                    <div class="mb-3">
                                        <label for="testimonialAvatar" class="form-label">Avatar Image Path</label>
                                        <input type="text" class="form-control" id="testimonialAvatar"
                                            name="content[avatar]" placeholder="public/website_images/review-1.png">
                                    </div>
                                    <div class="mb-3">
                                        <label for="testimonialRating" class="form-label">Rating (1-5)</label>
                                        <input type="number" class="form-control" id="testimonialRating"
                                            name="content[rating]" min="1" max="5" placeholder="5">
                                    </div>
                                    <div class="mb-3">
                                        <label for="testimonialText" class="form-label">Testimonial Text</label>
                                        <textarea class="form-control" id="testimonialText" name="content[text]" rows="3"
                                ...
                                <div id="faqHeaderFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="faqHeaderBadge"
                                            name="content[badge]" placeholder="Common Questions">
                                    </div>
                                    <div class="mb-3">
                                        <label for="faqHeaderTitle" class="form-label">Title</label>
                                        <input type="text" class="form-control" id="faqHeaderTitle"
                                            name="content[title]" placeholder="Frequently Asked Questions">
                                    </div>
                                    <div class="mb-3">
                                        <label for="faqHeaderSidebarImage" class="form-label">Sidebar Image
                                            URL</label>
                                        <input type="text" class="form-control" id="faqHeaderSidebarImage"
                                            name="content[sidebar_image]"
                                            placeholder="Sidebar image URL (e.g., https://...gif)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="faqHeaderSidebarTitle" class="form-label">Sidebar Title</label>
                                        <input type="text" class="form-control" id="faqHeaderSidebarTitle"
                                            name="content[sidebar_title]" placeholder="Need personalized help?">
                                    </div>
                                    <div class="mb-3">
                                        <label for="faqHeaderSidebarDescription" class="form-label">Sidebar
                                            Description</label>
                                        <textarea class="form-control" id="faqHeaderSidebarDescription" name="content[sidebar_description]" rows="2"
                                            placeholder="Sidebar description"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="faqHeaderContactBoxTitle" class="form-label">Contact Box
                                            Title</label>
                                        <input type="text" class="form-control" id="faqHeaderContactBoxTitle"
                                            name="content[contact_box_title]" placeholder="Contact Us">
                                    </div>
                                    <div class="mb-3">
                                        <label for="faqHeaderContactBoxDescription" class="form-label">Contact Box
                                            Description</label>
                                        <textarea class="form-control" id="faqHeaderContactBoxDescription" name="content[contact_box_description]"
                                            rows="2" placeholder="Contact box description"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="faqHeaderContactButtonText" class="form-label">Contact Button
                                            Text</label>
                                        <input type="text" class="form-control" id="faqHeaderContactButtonText"
                                            name="content[contact_button_text]" placeholder="Message Support">
                                    </div>
                                </div>
                                ...
                                <div id="faqFields" style="display:none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="faqQuestion"
                                            name="content[question]" placeholder="FAQ question">
                                    </div>
                                    <div class="mb-3">
    ...
    <script>
        ...
        function editContent(button, id, section, itemKey, sortOrder, isActive) {
            ...
            form.action = '{{ route('admin.update-express-air-freight-solutions-content', ['id' => '__ID__']) }}'.replace(
                '__ID__', id);
            ...
            switch (section) {
                case 'hero':
                    ...
                    if (Array.isArray(content.stat_pills)) {
                        document.getElementById('heroStatPills').value = content.stat_pills.map(s =>
                            `${s.icon}|${s.value}|${s.label}|${s.color}|${s.text_color}`).join('\n');
                    } else {
        ...
        document.getElementById('editForm').addEventListener('submit', function(e) {
            ...
            let url = id ? `${BASE_URL}/admin/update-express-air-freight-solutions-content/${id}` :
                `${BASE_URL}/admin/store-express-air-freight-solutions-content`;
        ...
        function getSectionFieldIds() {
            return ['heroFields', 'statsFields', 'featuresFields', 'featuresHeaderFields', 'overviewFields',
                'testimonialsHeaderFields', 'testimonialsFields', 'faqFields', 'faqHeaderFields'
            ];
        }
        ...
        function buildSectionFormData(form) {
            ...
            if (activeFieldId) {
                document.querySelectorAll(`#${activeFieldId} input, #${activeFieldId} textarea, #${activeFieldId} select`)
                    .forEach(el => {
