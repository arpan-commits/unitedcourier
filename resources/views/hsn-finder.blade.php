    ...
    <div class="container">
        <div class="row align-items-center g-4 g-lg-5">
            ...
            <div class="col-lg-12 text-center animate__animated animate__fadeInLeft">
                ...
                <a href="#" class="book-btn-service"><i
                        class="{{ $heroContent->page_icon_class ?? 'fa-solid fa-camera' }}"></i> &nbsp;
                    {{ $heroContent->page_button_text ?? 'Capture Again' }}</a>
            ...
            @empty
                <div class="col-md-4">
                    <div class="feature-card bg-light">
                        ...
                        <h5>Upload Image</h5>
                        <p>Snap a photo or upload an existing image in JPG, PNG, or WEBP format with a maximum file size
                            of 15MB.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="feature-card bg-light">
                        ...
                        <h5>AI Analysis</h5>
                        <p>Our smart AI analyzes your product, checks materials, structure, features, and other
                            important details for accurate classification.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="feature-card bg-light">
                        ...
                        <h5>Get Results</h5>
                        <p>Instantly receive the HSN & HTS codes with confidence scores and additional insights for
                            complex or sensitive products.</p>
                    </div>
                </div>
            @endforelse
        </div>
            ...
            <div class="slider-track">
                ...
                @empty
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="user-info"> <img src="{{ asset('website_images/review-1.png') }}"
                                class="img-fluid">
                            <h6>Shelly Kapoor</h6>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-card">
                        <div class="stars">★★★★★</div>
                        <p class="testimonial-text">"Affordable pricing combined with premium quality service makes
                            United
                    ...
                    <div class="testimonial-card">
                        <div class="stars">★★★★★</div>
                        <p class="testimonial-text">"Professional and efficient team handled my bulk shipments
                            perfectly,
                            ensuring timely delivery, careful handling, and a completely hassle-free logistics
                            experience"
                        </p>
                        <div class="user-info"> <img src="{{ asset('website_images/review-5.png') }}"
                                class="img-fluid">
                            <h6>Karan Singh</h6>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-card">
                        <div class="stars">★★★★★</div>
                        <p class="testimonial-text">"United Worldwide Couriers delivered my international parcel
                            quickly and
                    ...
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">"Very reliable logistics partner with consistent performance,
                            ensuring
                            all my shipments arrive safely, securely, and always on time without any issues."</p>
                        <div class="user-info"><img src="{{ asset('website_images/review-6.png') }}"
                                class="img-fluid">
                            <h6>Shelly Kapoor</h6>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">"Customer support team is highly responsive and helpful, assisting
                            me in
                            tracking my urgent shipment with accurate real-time updates and guidance."</p>
                        <div class="user-info"><img src="{{ asset('website_images/review-7.png') }}"
                                class="img-fluid">
                            <h6>Vansh Agarwal</h6>
                        </div>
                    </div>
                    ...
                    @empty
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq1" class="accordion-collapse collapse show"
                                data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    HSN (Harmonized System of Nomenclature) is a standardized system of names and
                                    numbers used to classify traded products. It is essential for determining customs
                                    duties, taxes, and regulatory requirements for international shipments.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    Simply upload a photo or image of your product, and our AI-powered tool analyzes its
                                    features, materials, and structure to provide you with the most accurate HSN and HTS
                                    code classification.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    We support JPG, PNG, and WEBP image formats with a maximum file size of 15MB. For
                                    best results, ensure your product image is clear and well-lit.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    HSN codes are used in India for classifying goods under the GST regime, while HTS
                                    (Harmonized Tariff Schedule) codes are used in the United States for customs and
                                    tariff purposes. Both are based on the same international Harmonized System.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    Yes, our HSN finder tool is completely free to use. You can upload images and get
                                    HSN/HTS code classifications without any charges or subscription fees.
                                </div>
                            </div>
                        </div>
                    @endforelse
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const canUseWebRTC = navigator.mediaDevices && typeof navigator.mediaDevices.getUserMedia ===
        'function';
        ...
        async function startCamera() {
            ...
            if (canUseWebRTC) {
                ...
                cameraErrorMessage.innerHTML =
                    '<i class="fa-solid fa-camera-retro" style="font-size:3rem;display:block;margin-bottom:10px;"></i> Opening device camera...';
        ...
        function capturePhoto() {
            ...
            capturedFile = new File([blob], 'captured-product.jpg', {
                type: mimeString
            });
