                    ...
                    @foreach ($featuresContent as $feature)
                        <div class="col-md-6 col-lg-3">
                            <div class="feature-card">
                                <div class="feature-icon {{ $feature->content['color_class'] }}"><i
                                        class="fas {{ $feature->content['icon'] }}"></i></div>
                    ...
                    <div class="col-lg-8 text-center">
                        @if (isset($testimonialsHeader->content['google_review_image']))
                            <div class="google-badge">
                                <a href="#">
                                    <img src="{{ asset('assets/' . $testimonialsHeader->content['google_review_image']) }}"
                                        alt="Google">
                                </a>
                            </div>
                        @endif
                    ...
                    <div class="slider-track">
                        @foreach ($testimonials as $testimonial)
                            <div class="testimonial-card">
                                <div class="stars">
                                    @for ($i = 0; $i < $testimonial->content['rating']; $i++)
                                        ★
                                    @endfor
                                </div>
                                <p class="testimonial-text">"{{ $testimonial->content['text'] }}"</p>
                                <div class="user-info">
                                    <img src="{{ asset('assets/' . $testimonial->content['avatar']) }}"
                                        class="img-fluid">
