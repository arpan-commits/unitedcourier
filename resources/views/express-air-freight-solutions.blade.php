...
@php
    ...
    $heroTitle =
        ...
        'Express <span class="moving-gradient-text">Air Freight Solutions</span> That Deliver';
    $heroDescription =
        $heroContent->content['description'] ??
        'Fast, reliable, and fully tracked international air freight — built for businesses that can\'t afford delays. Your cargo, delivered anywhere in the world with precision and care.';
    ...
    <div class="container">
        <div class="row align-items-center g-4 g-lg-5">
            ...
            <div class="col-md-6 text-md-start text-center animate__animated animate__fadeInLeft">
                ...
                <a href="{{ url('/login') }}" class="book-btn-service">
                    <i class="fas fa-paper-plane"></i> Book a Shipping
                </a>

                <a href="{{ url('/contact-us') }}" class="quote-btn-service">
                    ...
                    <div class="plane-circle">
                        ...
                        @foreach ($heroStatPills as $pill)
                            <div class="stat-pill pill-{{ $loop->iteration }}">
                                <div class="sp-icon"
                                    style="background:{{ $pill['color'] }};color:{{ $pill['text_color'] }}"><i
...
@php
    $overviewTitle =
        $overviewContent->content['title'] ??
        'Air Express Services <span class="gradient-text">Built Around Your Needs</span>';
    $overviewDescription =
        $overviewContent->content['description'] ??
        'United Worldwide Couriers offers an exceptional Express Air Freight service built for B2B enterprises, e-commerce businesses, and time-critical international shipments. We operate an end-to-end ecosystem from collection to customs clearance to last-mile delivery all under one roof.';
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-content">
                    ...
                    <a href="/login" class="sr-demo-btn-live mt-3">Book Shipments</a>
                </div>
            </div>
...
@php
    ...
    $featuresHeaderDescription =
        ...
        'Every feature is designed to give your business a competitive edge — speed, transparency, and reliability, every single shipment. Join our growing network of satisfied clients who depend on us for easy, secure, fast, and efficient logistics solutions.';
@endphp
            ...
            @forelse($featuresContent as $feature)
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="feature-card">
                        <div class="feature-icon {{ $feat['color_class'] ?? 'fi-blue' }}"><i
                                class="fas {{ $feat['icon_class'] ?? ($feat['icon'] ?? 'fa-satellite') }}"></i></div>
                        <h5>{{ $feat['title'] ?? '' }}</h5>
            ...
            @empty
                <div class="col-md-6 col-lg-3">
                    <div class="feature-card">
                        ...
                        <p>Monitor your shipment at every checkpoint — from pickup to customs to final-mile — through
                            our
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="feature-card">
                        ...
                        <p>Specialized cold-chain and pharma-grade shipping options for sensitive or perishable cargo
                            types.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="feature-card">
                        ...
                        <h5>24/7 Support</h5>
                        <p>Our logistics experts are available around the clock — via phone, chat, or email — to resolve
                            any
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="feature-card">
                        ...
                        <p>Carbon-offset shipping options and sustainable packaging solutions for businesses committed
                            to
...
@php
    ...
    $testimonialsHeaderDescription =
        ...
        'Join our growing network of satisfied clients who depend on us for easy, secure, fast, and efficient logistics solutions.';
            ...
            <div class="slider-track">
                ...
                @forelse($testimonials as $testimonial)
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="user-info">
                            <img src="{{ asset($tContent['avatar'] ?? ($tContent['customer_image'] ?? 'public/website_images/review-1.png')) }}"
                                class="img-fluid">
                ...
                @empty
                    <div class="testimonial-card">
                        <div class="stars">★★★★★</div>
                        <p class="testimonial-text">"Very reliable logistics partner with consistent performance,
                            ensuring all my shipments arrive safely, securely, and always on time."</p>
                        <div class="user-info">
                ...
                @empty
                    <div class="testimonial-card">
                        <div class="stars">★★★★★</div>
                        <p class="testimonial-text">"Customer support team is highly responsive and helpful, assisting
                            me in tracking my urgent shipment with accurate real-time updates and guidance."</p>
                        <div class="user-info"><img src="{{ asset('public/website_images/review-2.png') }}"
                                class="img-fluid">
                            <h6>Vansh Agarwal</h6>
                        </div>
                    </div>
...
@php
    ...
    $faqSidebarImage =
        $faqHeader->content['sidebar_image'] ??
    ...
    $faqSidebarDescription =
        $faqHeader->content['sidebar_description'] ??
        'Our logistics experts are available 24/7 to assist your requirements.';
    $faqContactBoxTitle = $faqHeader->content['contact_box_title'] ?? 'Contact Us';
    $faqContactBoxDescription =
        $faqHeader->content['contact_box_description'] ??
        'For urgent inquiries regarding your current shipment status.';
                    ...
                    @empty
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq1" class="accordion-collapse collapse show"
                                data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    To connect with our team, you have to register yourself, get a quote, and schedule
                                    your
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    We utilize study and secure packaging for small to large packages to protect your
                                    goods
                                    during transit. In case of fragile items, they will be cushioned enough and clearly
                                    labelled as "Fragile". In addition, we also provide a packaging and labelling guide
                                    for
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    Yes. To keep the clients informed, our team provides regular updates via email or
                                    SMS
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq6" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    Yes, we specialize in managing bulk as well as commercial consignments with
                                    easy-flowing
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq7" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    Yes, you can easily schedule a pick up at your preferred time either by reaching out
                                    to
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq8" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    Through our online tracking system, you can track your shipment in real-time. For
                                    that,
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq9" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    It depends on the service and location. So, your shipment may be picked up either by
                                    our
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq10" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    Yes, while others face limited support, we complete international customs
                                    documentation
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq11" class="accordion-collapse collapse" data-bs-parent="#logisticsFaq">
                                <div class="accordion-body">
                                    First things first, the team proactively monitors the shipment to identify and
                                    resolve
