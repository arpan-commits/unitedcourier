        ...
        <div class="row align-items-center g-4 g-lg-5">
            ...
            <div class="col-lg-7 animate__animated animate__fadeInLeft">
                <h1 class="hero-title mb-4">
                    {!! $hero->content['title'] ??
                        'Be a Part of the Fastest <br class="d-none d-md-block"> <span class="moving-gradient-text">Growing Ecosystem</span>' !!}
                </h1>
                <p class="lead mb-5">
            ...
            <div class="col-lg-5 animate__animated animate__fadeInRight">
                <img src="{{ asset($hero->image ?? 'images/partnership.webp') }}" alt="Hero Image"
                ...
                @foreach ($features as $feature)
                    <div class="lead d-flex align-items-center gap-3 mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            stroke-linejoin="round" data-lucide="check-circle" aria-hidden="true"
                            class="lucide lucide-check-circle text-primary">
        ...
        <div class="row align-items-center">
            <div class="">
                <span class="heading-badge animate-on-scroll" data-anim="animate__fadeInRight"
                    style="animation-delay: 0.2s;">{{ $ecosystemSection->content['badge'] ?? 'Our Export Ecosystem Partners' }}</span>
                <h2 class="about-title">
                    {{ $ecosystemSection->content['title'] ?? 'Powering global commerce through strong, trusted partnerships' }}
                </h2>
                <p class="mb-2 about-desc text-center animate-on-scroll" data-anim="animate__fadeInUp"
                ...
                <div class="uwd-pt-eco-card">
                    ...
                    <div class="uwd-pt-logo-grid">
                        @foreach ($ecosystemGlobalCards as $card)
                            <div class="uwd-pt-logo-item"><img src="{{ asset($card->image) }}" class="img-fluid"
                                    alt="{{ $card->title ?? 'Marketplace' }}"></div>
                        @endforeach
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="faq-header">
            ...
            <p class="about-desc text-center">
                {{ $faqSection->content['description'] ?? 'Join India\'s leading logistics brand, where trust and shared success drive lasting partnerships as we empower Indian exporters to go global.' }}
            </p>
        </div>
