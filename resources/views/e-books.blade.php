...
@php
    ...
    $heroSubtitle =
        ...
        'Must-read guides, handpicked for their popularity among global
exporters';
...
<div class="uwd-section-container">
    ...
    @php
        ...
        $sectionDescription =
            $sectionHeader->content['description'] ??
            'EGet your hands on our eBooks and learn about
...
@php
    ...
    $faqSidebarDescription =
        ...
        'Our logistics experts are available 24/7 to
assist your requirements.';
    ...
    $faqContactBoxDescription =
        ...
        'For urgent inquiries regarding your
