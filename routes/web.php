...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        Route::get('/pricing-quotes', [AdminController::class, 'pricingQuotes'])->name('admin.pricing-quotes');
        Route::get('/partnership-form', [AdminController::class, 'partnershipForm'])->name('admin.partnership-form');
...
Route::prefix('customer')->name('customer.')->group(function () {
    ...
    Route::post('/contact-us-submit', [customerController::class, 'saveContactUs'])->name('contact-us.submit');
    Route::post('/submit-pricing-quotes', [customerController::class, 'submit_pricing_quotes'])->name('submit_pricing_quotes');
    Route::post('/partnership-form/submit', [customerController::class, 'submit_partnership_form'])->name('partnership-form.submit');
